...
CREATE INDEX idx_chat_interno_de     ON chat_interno(de_user_id, created_at DESC);
CREATE INDEX idx_chat_interno_para   ON chat_interno(para_user_id, created_at DESC);
CREATE INDEX idx_chat_interno_conversa ON chat_interno(de_user_id, para_user_id, created_at DESC);
